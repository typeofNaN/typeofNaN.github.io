...
const CommonHeader = () => {
  return (
    <header className="fixed top-0 left-0 w-full h-60px z-99 bg-[rgba(255,255,255,.6)] dark:bg-[rgba(68,68,68,.6)] b-b-1px b-b-solid b-b-[rgb(222,222,222)] dark:b-b-[rgb(35,35,35)] backdrop-blur-5px">
